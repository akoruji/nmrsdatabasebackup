 ...
 */
package org.openmrs.module.nmrsdatabasebackup.web.controller;
 ...
 */
@Controller("${rootrootArtifactid}.NMRSDatabaseBackupModuleController")
@RequestMapping(value = "module/${rootArtifactid}/${rootArtifactid}.form")
public class NMRSDatabaseBackupModuleController {
